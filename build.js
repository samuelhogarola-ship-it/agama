...
async function build() {
  ...
  const COPY_DIRS = ['filiales', 'contacto', 'legal', 'faqs', 'blog', 'blog-agama', 'entrada-de-blog', 'blog-assets', 'vacantes', 'entregas', 'eventos', 'pigmentos', 'masterbatch', 'aditivos', 'productos', 'home-v2'];

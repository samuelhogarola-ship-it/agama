...
- fix(imagen): la referencia visual compartida de Masterbatch elimina el recipiente gris, adopta nombres versionados para evitar caché y actualiza todas sus apariciones públicas y el generador del catálogo.
